...
| `stockMarketImportance` | optional | 1–10 | Stock market importance (star UI). Score per the rubric in [data-quality.md](./data-quality.md#stock-market-importance-scoring-rubric): how directly the term moves prices / is used in real investing, not academic significance. 9-10 live market-wide drivers, 7-8 core macro variables, 5-6 indirect, 3-4 background concepts, 1-2 pure theory/history. |
